...
-- Bundle auditado pelo Supabase skill.
-- Continuação para banco parcialmente configurado.
-- Usa planejamento v3 e acervo v2; migrations antigas conflitantes excluídas.
