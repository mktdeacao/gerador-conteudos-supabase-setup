...
DROP POLICY IF EXISTS "Users can update org files" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can delete org files" ON storage.objects;
...
DO $$ BEGIN
  DROP POLICY IF EXISTS "service_role_all" ON member_clients;
...
DO $$ BEGIN
  DROP POLICY IF EXISTS "service_role_all" ON social_accounts;
...
DO $policy$ BEGIN
  DROP POLICY IF EXISTS "service_role_all" ON client_assets;
...
DO $policy$ BEGIN
  DROP POLICY IF EXISTS "service_role_all_categorias" ON acervo_categorias;
  CREATE POLICY "service_role_all_categorias" ON acervo_categorias FOR ALL USING (true) WITH CHECK (true);
EXCEPTION WHEN duplicate_object THEN NULL;
END $policy$;

DO $policy$ BEGIN
  DROP POLICY IF EXISTS "service_role_all_arquivos" ON acervo_arquivos;
  CREATE POLICY "service_role_all_arquivos" ON acervo_arquivos FOR ALL USING (true) WITH CHECK (true);
EXCEPTION WHEN duplicate_object THEN NULL;
END $policy$;

DO $policy$ BEGIN
  DROP POLICY IF EXISTS "service_role_all_downloads" ON acervo_downloads;
